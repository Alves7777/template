...
@section('content')
    ...
    @include('confirm-delete', ['url' => route('sectionfive.destroy', $sectionfive->id)])
    <div class="row">
        <div class="col-12">
            <div class="card card-purple card-outline">
                <div>
                    <div class="card-header">
                        <div class="card-tools" style="display: flex; justify-content: flex-end; align-items: center; ">
                            <div>
                                <a href="{{ route('sectionfive.index')}}" class="btn btn-sectionone" type="submit"
                ...
                <div class="card-body">
                    <p><strong>Título_1: </strong>{{ $sectionfive->sub_title  }}</p>
                    <hr>
                    <div>
