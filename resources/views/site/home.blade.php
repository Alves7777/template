        ...
        <main id="main">
            ...
            <section id="featured-services" class="featured-services">
                <div class="container" data-aos="fade-up">
                    @foreach($getFreight as $item)
                    <div class="row">
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                                <div class="icon"><i class="bx bxl-dribbble"></i></div>
                                <h4 class="title" id=""><a href="">{{ $item['plate']  }}</a></h4>
                                <p class="description" id="">{{ $item['vehicle_owner'] }}</p>
                                <p class="description" id="">{{ $item['cost_of_freight'] }}</p>
                                <p class="description" id="">{{ $item['start_date'] }}</p>
                                <p class="description" id="">{{ $item['end_date'] }}</p>
                                <p class="description" id=""><strong>{{ $item['status'] }}</strong></p>
                            </div>
                        </div>
