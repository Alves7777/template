    <section id="topbar" style="background: red" class="d-flex align-items-center">
        ...
        <div class="contact-info d-flex align-items-center">
            ...
            <i class="p-2 {{ $topbars->icon_phone }} d-flex align-items-center"><a
                    target="_blank"
                    href="https://web.whatsapp.com/send?phone=55{{ $topbars->phone }}&text=Olá, entrei no site, gostaria de algumas informações.">{{ $topbars->phone }}</a></i>
        </div>
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="{{ $navbars->link_title_10 }}"><i
                                class=""></i>{{$navbars->title_10}}</a>
                    <li><a class="nav-link scrollto" href="{{ $navbars->link_title_11 }}"><i
                                class=""></i>{{$navbars->title_11}}</a>
                    </li>
                </ul>
