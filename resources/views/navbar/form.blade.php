            ...
            <div class="form-group">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="link_title_1"  class="custom-select mr-sm-2" id="languages-select-1">
                        <option value="{{ $navbar->link_title_1 ?? old('link_title_1') }}" selected="">Selecione a Página</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="link_title_2"  class="custom-select mr-sm-2" id="languages-select-1">
                        <option value="{{ $navbar->link_title_2 ?? old('link_title_1') }}" selected="">Selecione a Página</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="link_title_3"  class="custom-select mr-sm-2" id="languages-select-1">
                        <option value="{{ $navbar->link_title_3 ?? old('link_title_1') }}" selected="">Selecione a Página</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="link_title_4"  class="custom-select mr-sm-2" id="languages-select-1">
                        <option value="{{ $navbar->link_title_4 ?? old('link_title_1') }}" selected="">Selecione a Página</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="link_title_5"  class="custom-select mr-sm-2" id="languages-select-1">
                        <option value="{{ $navbar->link_title_5 ?? old('link_title_1') }}" selected="">Selecione a Página</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="link_title_11"  class="custom-select mr-sm-2" id="languages-select-1">
                        <option value="{{ $navbar->link_title_11 ?? old('link_title_1') }}" selected="">Selecione a Página</option>
                    </select>
                </div>
            </div>
        </div>
