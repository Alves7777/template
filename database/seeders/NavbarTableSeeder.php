...
class NavbarTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->navbar->create([
            // 'logo'    => new UploadedFile(public_path() . '/storage/photos/logo.jpeg', originalName: 'temp'),
            'logo'    => new UploadedFile('photos/ampratas/logo.jpg','temp'),
            'title_1' => 'Home',
            'title_2' => 'Sobre',
            'title_3' => 'Serviços',
            'title_4' => 'Portifólio',
            ...
            'link_title_8' => 'page_8',
            'link_title_9' => 'page_11',
            'link_title_10' => 'https://wa.me/5585996744989?text=Gostaria+falar+com+um+vendedor...',
            'link_title_11' => 'https://www.instagram.com/ampratass__',
